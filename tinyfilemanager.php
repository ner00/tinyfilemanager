                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-5">
                            <select class="form-select w-100" id="js-zip-compression" name="js-zip-compression">
                                <option value='0' <?php if ($zip_compression == "0") {
                                                        echo "selected";
                                                    } ?>>
                                    <?php echo lng('None') ?>
                                </option>
                                <option value='1' <?php if ($zip_compression == "1") {
                                                        echo "selected";
                                                    } ?>>
                                    <?php echo lng('Default') ?>
                                </option>
                                <option value='2' <?php if ($zip_compression == "2") {
                                                        echo "selected";
                                                    } ?>>
                                    <?php echo lng('High') ?>
                                </option>
        ...
        <?php if (!FM_READONLY): ?>
            <div class="col-xs-12 col-sm-9">
                <div class="btn-group flex-wrap" data-toggle="buttons" role="toolbar">
                    ...
                    <input type="submit" class="hidden" name="download" id="a-download" value="Download" onclick="return confirm('<?php echo lng('Download selected files and folders?'); ?>')">
                    <a href="javascript:document.getElementById('a-download').click();" class="btn btn-small btn-outline-primary btn-2"><i class="fa fa-download"></i> <?php echo lng('Download') ?> </a>
...
function fm_get_zif_info($path, $ext)
{
    if ($ext == 'zip' && function_exists('zip_open')) {
        ...
        if (round(fm_get_size($path)/1024/1024) > FM_MAX_GZTARBALL_SIZE_SCAN_INFO_MBYTES && ($ext == 'tgz' || substr($path, -7) == '.tar.gz' || substr($path, -8) == '.tar.bz2')) {
                ...
                <ul class="navbar-nav justify-content-end" data-bs-theme="<?php echo FM_THEME; ?>">
                    ...
                    <?php if (FM_USE_AUTH): ?>
                        <li class="nav-item avatar dropdown">
                            ...
                            <div class="dropdown-menu text-small shadow" aria-labelledby="navbarDropdownMenuLink-5" data-bs-theme="<?php echo FM_THEME; ?>" style="left:-35px;">
                                <?php if (!FM_READONLY): ?>
